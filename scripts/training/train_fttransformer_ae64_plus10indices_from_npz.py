#!/usr/bin/env python3
"""
Train an FT-Transformer classifier on AE64 + 10 indices samples stored in NPZ.
...
Example:
python scripts/training/train_fttransformer_ae64_plus10indices_from_npz.py \
  --data data/processed/training/ae64_plus10indices_samples_4upazila_2023_trainvaltest.npz \
  --outdir runs/ftt_ae64plus10idx_dt128_blk2_head8_attndo01_ffdo01_lr1e3_bs384_acc4_amp_v1 \
  --d-token 128 \
  --n-blocks 2 \
  --n-heads 8 \
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train FT-Transformer classifier on AE64 + 10 indices NPZ.")
    p.add_argument(
        "--data",
        type=Path,
