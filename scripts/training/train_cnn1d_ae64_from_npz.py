#!/usr/bin/env python3
"""
Train a 1D-CNN classifier on AE64 samples stored in NPZ.
...
Example:
python scripts/training/train_cnn1d_ae64_from_npz.py \
  --data data/processed/training/ae64_samples_4upazila_2023_trainvaltest.npz \
  --outdir runs/cnn1d_ae64_c32-64-128_k5-3-3_h128_do02_lr1e3_bs4096_v1 \
  --channels 32 64 128 \
  --kernels 5 3 3 \
  --head-dim 128 \
  --dropout 0.2 \
...
- The 1D-CNN treats the 64 AE features as a 1D sequence of length 64.
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train 1D-CNN classifier on AE64 NPZ.")
    p.add_argument(
        "--data",
        type=Path,
