...
# ==============================================================================
# Purpose: Run lgbm ae64plus10idx grid.
...
#   bash scripts/training/run_lgbm_ae64plus10idx_grid.sh
#
...
# ============================================================
# LightGBM grid search runner for AE64 + 10 indices classification
# ============================================================
#
# Runs 10 experiments and writes:
#   - per-run logs:
#       logs/lgbm_ae64plus10idx_grid/<run_name>.log
#   - master comparison CSV:
#       runs/lgbm_ae64plus10idx_master_runs.csv
#
# Usage:
#   chmod +x scripts/training/run_lgbm_ae64plus10idx_grid.sh
...
TRAIN_SCRIPT="scripts/training/train_lgbm_ae64_plus10indices_from_npz.py"

LOG_DIR="logs/lgbm_ae64plus10idx_grid"
MASTER_CSV="runs/lgbm_ae64plus10idx_master_runs.csv"
...
# - best iteration around 801
# - AE64 + 10 indices is stronger than AE64-only
# - still a clear train-vs-val gap, so several runs add
#   regularization pressure rather than only increasing capacity
#
# Search logic:
# - smaller/larger num_leaves around 127
# - stronger min_child_samples
# - lr around 0.03
# - modest row/column subsampling variation
# - mild L1/L2 regularization
# - one slightly larger-capacity candidate
# ------------------------------------------------------------

run_one "lgbm_ae64plus10idx_lr0.03_ne5000_nl127_mcs50_sub0.8_col0.8_es200_v1" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --num-leaves 127 \
...
run_one "lgbm_ae64plus10idx_lr0.03_ne5000_nl63_mcs50_sub0.8_col0.8_es200_v2" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --num-leaves 63 \
  --min-child-samples 50 \
...
run_one "lgbm_ae64plus10idx_lr0.03_ne5000_nl255_mcs50_sub0.8_col0.8_es200_v3" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --num-leaves 255 \
  --min-child-samples 50 \
...
run_one "lgbm_ae64plus10idx_lr0.03_ne5000_nl127_mcs100_sub0.8_col0.8_es200_v4" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --num-leaves 127 \
...
run_one "lgbm_ae64plus10idx_lr0.03_ne5000_nl127_mcs200_sub0.8_col0.8_es200_v5" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --num-leaves 127 \
...
run_one "lgbm_ae64plus10idx_lr0.02_ne7000_nl127_mcs50_sub0.8_col0.8_es250_v6" \
  --learning-rate 0.02 \
  --n-estimators 7000 \
  --num-leaves 127 \
  --min-child-samples 50 \
...
run_one "lgbm_ae64plus10idx_lr0.05_ne4000_nl127_mcs50_sub0.8_col0.8_es150_v7" \
  --learning-rate 0.05 \
  --n-estimators 4000 \
  --num-leaves 127 \
  --min-child-samples 50 \
...
run_one "lgbm_ae64plus10idx_lr0.03_ne5000_nl127_mcs50_sub0.7_col0.7_es200_v8" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --num-leaves 127 \
  --min-child-samples 50 \
...
run_one "lgbm_ae64plus10idx_lr0.03_ne5000_nl127_mcs100_sub0.8_col0.8_ra0.1_rl0.5_es200_v9" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --num-leaves 127 \
  --min-child-samples 100 \
...
run_one "lgbm_ae64plus10idx_lr0.02_ne7000_nl191_mcs100_sub0.75_col0.75_ra0.2_rl1.0_es250_v10" \
  --learning-rate 0.02 \
  --n-estimators 7000 \
  --num-leaves 191 \
  --min-child-samples 100 \
...
master_csv = Path("runs/lgbm_ae64plus10idx_master_runs.csv")
