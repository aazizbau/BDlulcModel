...
~~~~~~~~~~~~~~~~~~~~~~~~~~~
The command-line interface exposes ``--ae``, ``--year``, ``--interim-dir``, ``--outdir``, ``--src-nodata``, ``--dst-nodata``, ``--resampling``. Run the ``--help`` command below for required values, defaults, and accepted choices.
