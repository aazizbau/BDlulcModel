...
# ==============================================================================
# Purpose: Run fttransformer ae64plus10idx grid.
...
#   bash scripts/training/run_fttransformer_ae64plus10idx_grid.sh
#
...
# ============================================================
# FT-Transformer grid search runner for AE64 + 10 indices classification
# ============================================================
#
# Runs 10 experiments and writes:
#   - per-run logs:
#       logs/fttransformer_ae64plus10idx_grid/<run_name>.log
#   - master comparison CSV:
#       runs/fttransformer_ae64plus10idx_master_runs.csv
#
# Usage:
#   chmod +x scripts/training/run_fttransformer_ae64plus10idx_grid.sh
...
#     v1 best val macro F1 = 0.7253 at epoch 16
...
# - Because input_dim is 74 (AE64 + 10 indices), some larger models use
#   slightly smaller physical batch sizes than the AE64-only grid.
# ============================================================
...
TRAIN_SCRIPT="scripts/training/train_fttransformer_ae64_plus10indices_from_npz.py"
LOG_DIR="logs/fttransformer_ae64plus10idx_grid"
MASTER_CSV="runs/fttransformer_ae64plus10idx_master_runs.csv"
...
# - stable and memory-safe with dt128, blk2, bs384, acc4, amp
# - validation improved until epoch 16, then plateaued
# - AE64 + 10 indices performed slightly better than AE64-only baseline
#
# Search logic:
...
run_one "ftt_ae64plus10idx_dt128_blk2_head8_attndo01_ffdo01_lr1e3_bs384_acc4_amp_v1" \
  --d-token 128 \
  --n-blocks 2 \
  --n-heads 8 \
...
run_one "ftt_ae64plus10idx_dt96_blk2_head8_attndo01_ffdo01_lr1e3_bs384_acc4_amp_v2" \
  --d-token 96 \
  --n-blocks 2 \
  --n-heads 8 \
  --attention-dropout 0.1 \
...
run_one "ftt_ae64plus10idx_dt160_blk2_head8_attndo01_ffdo01_lr1e3_bs256_acc4_amp_v3" \
  --d-token 160 \
  --n-blocks 2 \
  --n-heads 8 \
  --attention-dropout 0.1 \
...
run_one "ftt_ae64plus10idx_dt128_blk3_head8_attndo01_ffdo01_lr1e3_bs256_acc4_amp_v4" \
  --d-token 128 \
  --n-blocks 3 \
  --n-heads 8 \
  --attention-dropout 0.1 \
...
run_one "ftt_ae64plus10idx_dt128_blk2_head8_attndo005_ffdo005_lr1e3_bs384_acc4_amp_v5" \
  --d-token 128 \
  --n-blocks 2 \
  --n-heads 8 \
...
run_one "ftt_ae64plus10idx_dt128_blk2_head8_attndo015_ffdo015_lr1e3_bs384_acc4_amp_v6" \
  --d-token 128 \
  --n-blocks 2 \
  --n-heads 8 \
...
run_one "ftt_ae64plus10idx_dt128_blk2_head8_attndo01_ffdo01_lr7e4_bs384_acc4_amp_v7" \
  --d-token 128 \
  --n-blocks 2 \
  --n-heads 8 \
  --attention-dropout 0.1 \
...
run_one "ftt_ae64plus10idx_dt128_blk2_head8_attndo01_ffdo01_lr5e4_bs384_acc4_amp_v8" \
  --d-token 128 \
  --n-blocks 2 \
  --n-heads 8 \
  --attention-dropout 0.1 \
...
run_one "ftt_ae64plus10idx_dt160_blk3_head8_attndo01_ffdo01_lr7e4_bs192_acc4_amp_v9" \
  --d-token 160 \
  --n-blocks 3 \
  --n-heads 8 \
  --attention-dropout 0.1 \
...
run_one "ftt_ae64plus10idx_dt96_blk3_head8_attndo015_ffdo01_lr7e4_bs256_acc4_amp_v10" \
  --d-token 96 \
  --n-blocks 3 \
  --n-heads 8 \
  --attention-dropout 0.15 \
...
python scripts/training/build_master_csv.py \
  ...
  --runs \
  "ftt_ae64plus10idx_dt128_blk2_head8_attndo01_ffdo01_lr1e3_bs384_acc4_amp_v1" \
  "ftt_ae64plus10idx_dt96_blk2_head8_attndo01_ffdo01_lr1e3_bs384_acc4_amp_v2" \
  "ftt_ae64plus10idx_dt160_blk2_head8_attndo01_ffdo01_lr1e3_bs256_acc4_amp_v3" \
  "ftt_ae64plus10idx_dt128_blk3_head8_attndo01_ffdo01_lr1e3_bs256_acc4_amp_v4" \
  "ftt_ae64plus10idx_dt128_blk2_head8_attndo005_ffdo005_lr1e3_bs384_acc4_amp_v5" \
  "ftt_ae64plus10idx_dt128_blk2_head8_attndo015_ffdo015_lr1e3_bs384_acc4_amp_v6" \
  "ftt_ae64plus10idx_dt128_blk2_head8_attndo01_ffdo01_lr7e4_bs384_acc4_amp_v7" \
  "ftt_ae64plus10idx_dt128_blk2_head8_attndo01_ffdo01_lr5e4_bs384_acc4_amp_v8" \
  "ftt_ae64plus10idx_dt160_blk3_head8_attndo01_ffdo01_lr7e4_bs192_acc4_amp_v9" \
  "ftt_ae64plus10idx_dt96_blk3_head8_attndo015_ffdo01_lr7e4_bs256_acc4_amp_v10"
...
master_csv = Path("runs/fttransformer_ae64plus10idx_master_runs.csv")
