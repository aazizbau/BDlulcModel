...
#   bash scripts/training/run_xgboost_ae64_grid.sh
#
...
# ============================================================
# XGBoost grid search runner for AE64 classification
# ============================================================
#
# Runs 10 experiments and writes:
#   - per-run logs:
#       logs/xgb_ae64_grid/<run_name>.log
#   - master comparison CSV:
#       runs/xgboost_ae64_master_runs.csv
#
# Usage:
#   chmod +x scripts/training/run_xgboost_ae64_grid.sh
...
TRAIN_SCRIPT="scripts/training/train_xgboost_ae64_from_npz.py"

LOG_DIR="logs/xgb_ae64_grid"
MASTER_CSV="runs/xgboost_ae64_master_runs.csv"
...
# - best iteration around 1781, far below 5000
# - validation performance is strong, but there is a clear
#   train-vs-val gap, so several runs should reduce overfitting
#
# Search logic:
...
run_one "xgb_ae64_lr0.03_ne5000_md10_mcw3_sub0.8_col0.8_es200_v1" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --max-depth 10 \
...
run_one "xgb_ae64_lr0.02_ne7000_md10_mcw3_sub0.8_col0.8_es300_v2" \
  --learning-rate 0.02 \
  --n-estimators 7000 \
  --max-depth 10 \
  --min-child-weight 3.0 \
...
run_one "xgb_ae64_lr0.03_ne5000_md8_mcw5_sub0.8_col0.8_es200_v3" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --max-depth 8 \
...
run_one "xgb_ae64_lr0.03_ne5000_md8_mcw8_sub0.8_col0.8_g0.1_ra0.0_rl2.0_es200_v4" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --max-depth 8 \
...
run_one "xgb_ae64_lr0.03_ne5000_md9_mcw5_sub0.7_col0.8_g0.1_ra0.1_rl2.0_es200_v5" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --max-depth 9 \
  --min-child-weight 5.0 \
...
run_one "xgb_ae64_lr0.03_ne5000_md10_mcw5_sub0.7_col0.7_g0.2_ra0.1_rl2.0_es200_v6" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --max-depth 10 \
  --min-child-weight 5.0 \
...
run_one "xgb_ae64_lr0.05_ne3000_md8_mcw5_sub0.8_col0.8_es150_v7" \
  --learning-rate 0.05 \
  --n-estimators 3000 \
  --max-depth 8 \
  --min-child-weight 5.0 \
...
run_one "xgb_ae64_lr0.02_ne8000_md9_mcw8_sub0.8_col0.8_g0.1_ra0.1_rl2.0_es300_v8" \
  --learning-rate 0.02 \
  --n-estimators 8000 \
  --max-depth 9 \
  --min-child-weight 8.0 \
...
run_one "xgb_ae64_lr0.03_ne5000_md12_mcw8_sub0.8_col0.8_g0.2_ra0.1_rl2.0_es200_v9" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --max-depth 12 \
  --min-child-weight 8.0 \
...
run_one "xgb_ae64_lr0.03_ne5000_md8_mcw10_sub0.9_col0.7_g0.2_ra0.5_rl3.0_es200_v10" \
  --learning-rate 0.03 \
  --n-estimators 5000 \
  --max-depth 8 \
...
python scripts/training/build_master_csv.py \
  ...
  --runs \
  "xgb_ae64_lr0.03_ne5000_md10_mcw3_sub0.8_col0.8_es200_v1" \
  "xgb_ae64_lr0.02_ne7000_md10_mcw3_sub0.8_col0.8_es300_v2" \
  "xgb_ae64_lr0.03_ne5000_md8_mcw5_sub0.8_col0.8_es200_v3" \
  "xgb_ae64_lr0.03_ne5000_md8_mcw8_sub0.8_col0.8_g0.1_ra0.0_rl2.0_es200_v4" \
  "xgb_ae64_lr0.03_ne5000_md9_mcw5_sub0.7_col0.8_g0.1_ra0.1_rl2.0_es200_v5" \
  "xgb_ae64_lr0.03_ne5000_md10_mcw5_sub0.7_col0.7_g0.2_ra0.1_rl2.0_es200_v6" \
  "xgb_ae64_lr0.05_ne3000_md8_mcw5_sub0.8_col0.8_es150_v7" \
  "xgb_ae64_lr0.02_ne8000_md9_mcw8_sub0.8_col0.8_g0.1_ra0.1_rl2.0_es300_v8" \
  "xgb_ae64_lr0.03_ne5000_md12_mcw8_sub0.8_col0.8_g0.2_ra0.1_rl2.0_es200_v9" \
  "xgb_ae64_lr0.03_ne5000_md8_mcw10_sub0.9_col0.7_g0.2_ra0.5_rl3.0_es200_v10"
...
master_csv = Path("runs/xgboost_ae64_master_runs.csv")
