...
~~~~~~~~~~~~~~~~~~~~~~~~~~~
The command-line interface exposes ``--year``, ``--upazila-parcels``, ``--input``, ``--parcels``, ``--north-arrow``, ``--palette``, ``--output-gpkg``, ``--output-png``. Run the ``--help`` command below for required values, defaults, and accepted choices.
