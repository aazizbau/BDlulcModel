...
~~~~~~~~~~~~~~~~~~~~~~~~~~~
The command-line interface exposes ``--class-2017``, ``--class-2024``, ``--uncertainty-2017``, ``--uncertainty-2024``, ``--zone-map``, ``--output-dir``. Run the ``--help`` command below for required values, defaults, and accepted choices.
