...
Example
-------
python scripts/visualization/visualize_comparison_jaxa_vs_dynamicworld_vs_studylulc.py
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~
The command-line interface exposes ``--b2-2023``, ``--b3-2023``, ``--b4-2023``, ``--dynamicworld``, ``--jaxa``, ``--study-lulc``, ``--output-fig``, ``--seed``, ``--window``, ``--window-width-px``, ``--window-height-px``, ``--max-attempts``, ``--n-rows``, ``--dpi``, ``--add-main-title``. Run the ``--help`` command below for required values, defaults, and accepted choices.
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--output-fig", default="outputs/figures/comparison_jaxa_vs_dynamicworld_vs_studylulc_2023.png")
