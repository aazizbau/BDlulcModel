...
~~~~~~~~~~~~~~~~~~~~~~~~~~~
The command-line interface exposes ``--zone``, ``--csv-2017``, ``--csv-2024``, ``--output-plot``, ``--output-csv``, ``--bootstrap``, ``--seed``, ``--add-title``. Run the ``--help`` command below for required values, defaults, and accepted choices.
