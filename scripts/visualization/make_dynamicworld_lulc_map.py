#!/usr/bin/env python3
"""
Create a publication-style Dynamic World yearly mode LULC map for a given year.
...
Output
------
- outputs/figures/bd_coastal_dynamicworld_lulc_<year>.png

Example
-------
python scripts/visualization/make_dynamicworld_lulc_map.py \
    --year 2017
"""
...
CLASS_NODATA = -1
MAP_TITLE_TEMPLATE = "Bangladesh Coastal Dynamic World LULC {year}"
...
def default_output_path(year: int) -> Path:
    return DEFAULT_OUTPUT_ROOT / f"bd_coastal_dynamicworld_lulc_{year}.png"


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Make Dynamic World yearly mode LULC map for a target year.")
