...
-------------------------------
Workflow role: Prepare the external Bangladesh HRLULC reference product for comparison.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Replace the source HRLULC files and boundary; preserve categorical values with nearest-neighbour processing.
