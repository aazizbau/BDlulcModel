...
~~~~~~~~~~~~~~~~~~~~~~~~~~~
The command-line interface exposes ``--output-root``, ``--seeds``, ``--resume``, ``--force``, ``--dry-run``. Run the ``--help`` command below for required values, defaults, and accepted choices.
