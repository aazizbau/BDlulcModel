...
~~~~~~~~~~~~~~~~~~~~~~~~~~~
The command-line interface exposes ``--input``, ``--pattern``, ``--clip-vector``, ``--output``, ``--overwrite``. Run the ``--help`` command below for required values, defaults, and accepted choices.
