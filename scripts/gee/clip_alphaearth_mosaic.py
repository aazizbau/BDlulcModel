...
~~~~~~~~~~~~~~~~~~~~~~~~~~~
The command-line interface exposes ``--input``, ``--output``, ``--vector``, ``--crs``, ``--cache-mb``, ``--progress-every-s``. Run the ``--help`` command below for required values, defaults, and accepted choices.
